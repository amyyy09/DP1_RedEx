...
public class CromosomaController {
    ...
    public static Cromosoma ejecutarAlgoritmoGenetico(List<Envio> envios, List<Aeropuerto> aeropuertos,
        ...
        String archivoRutas = IOController.chooseFile("Cargar Rutas Predefinidas");
        List<RutaPredefinida> rutasPred = IOController.obtenerRutasConEscalas(aeropuertos, archivoRutas);
        List<Cromosoma> poblacion = IOController.createPopulation(envios, rutasPred, numCromosomas, aeropuertos);
