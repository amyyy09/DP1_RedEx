...
public class EnvioController {
    ...
    public List<Envio> getEnviosByFechaHora(@RequestParam String fechaHora) {
        ...
        return envioService.getEnviosPorFechaHora(fechaHoraParsed, null);
    }

    @PostMapping("/save")
    public ResponseEntity<String> saveEnvio(@RequestBody Envio envio) {
        try {
            envioService.saveEnvio(envio);
            return ResponseEntity.ok("Envio saved successfully.");
        } catch (Exception e) {
