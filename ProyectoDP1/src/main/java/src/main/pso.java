...
public class pso {
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<String> destinosEspecificos = Arrays.asList("SKBO","SEQM","SVMI","SBBR","SPIM","SLLP","SCEL","SABE","SGAS","SUAA","LATI", "EDDI","LOWW","EBCI","UMMS","LBSF","LKPR","LDZA","EKCH","EHAM","VIDP","OSDI", "OERK","OMDB","OAKB","OOMS","OYSN","OPKC","UBBB","OJAI"); //para nuestro experimento tenemos solo un aeropuerto destino WMKK
			for (String destino : destinosEspecificos) {
				...
				vueloService.guardarRutasEnCSV(rutasPred, "RutasPred/rutas_predefinidas_" + destino + ".csv");
			}
